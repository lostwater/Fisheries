...
namespace csharp_upload_sdk
{
    ...
    class LetvCloud
    {
        ...
        */
        private static String userUnique = "143a7f651d";
        private static String secretKey = "bd750fd7e639e0d8e27ddd46c38423df";
        ...
        private static jsonout jsonGet(String src)
        {
        ...
        /// <param name="src">字符串</param>
        /// <returns>json结构体</returns>
        private static jsonResume jsonGetResume(String src)
        {
            JavaScriptSerializer serializer = new JavaScriptSerializer();
        ...
        public static void TestUploadOneFile() {
            String result = videoUploadInit("letv2", "192.168.1.1");
        ...
        public byte[] upload(string video_name,string client_ip,string file_path)
        {
